package org.jeecg.modules.demo.domain.controller;
...
import org.jeecg.modules.demo.domain.entity.SysProduct;
import org.jeecg.modules.demo.domain.service.ISysProductService;
 ...
 */
@RestController
@RequestMapping("/domain/sysProduct")
@Slf4j
public class SysProductController extends JeecgController<SysProduct, ISysProductService> {
	...
	public Result<?> queryPageList(SysProduct sysProduct,
	...
	public Result<?> add(@RequestBody SysProduct sysProduct) {
	...
	public Result<?> edit(@RequestBody SysProduct sysProduct) {
    ...
    */
    ...
    public ModelAndView exportXls(HttpServletRequest request, SysProduct sysProduct) {
        return super.exportXls(request, sysProduct, SysProduct.class, "系统商品");
    }
